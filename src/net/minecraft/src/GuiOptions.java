...
public class GuiOptions extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        controlList.add(new GuiButton(100, width / 2 - 110, height / 6 + 120 + 24,100,20, "Controls..."));
        controlList.add(new GuiButton(150, width / 2 + 10, height / 6 + 120 + 24,100,20, "Texture Packs"));
        controlList.add(new GuiButton(200, width / 2 - 100, height / 6 + 172, "Done"));
    }
